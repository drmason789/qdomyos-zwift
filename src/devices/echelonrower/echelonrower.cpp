...
resistance_t echelonrower::pelotonToBikeResistance(peloton_t pelotonResistance) {
...
resistance_t echelonrower::resistanceFromPowerRequest(power_t power) {
